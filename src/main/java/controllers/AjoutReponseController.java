...
import models.User;  // ✅ Ensure we use User
...
public class AjoutReponseController {
    ...
    public void setUser(User user) {  // ✅ Now works with User
        this.user = user;
    }
    ...
    private void ajouterReponse() {
        ...
        try {
            Reponse nouvelleReponse = new Reponse(reclamation, user, contenuFiltre, imageData, new Date());  // ✅ Now using User
